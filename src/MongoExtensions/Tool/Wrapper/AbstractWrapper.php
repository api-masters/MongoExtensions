...
namespace MongoExtensions\Tool\Wrapper;

use Doctrine\ODM\MongoDB\DocumentManager;
use Doctrine\Common\Persistence\ObjectManager;
use Doctrine\ORM\EntityManagerInterface;
use MongoExtensions\Tool\WrapperInterface;
use MongoExtensions\Exception\UnsupportedObjectManagerException;
...
abstract class AbstractWrapper implements WrapperInterface
{
     ...
     *
     * @throws \MongoExtensions\Exception\UnsupportedObjectManagerException
     *
     * @return \MongoExtensions\Tool\WrapperInterface
     */

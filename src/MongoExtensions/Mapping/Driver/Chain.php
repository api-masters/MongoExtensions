...
namespace MongoExtensions\Mapping\Driver;
...
class Chain implements Driver
{
    ...
    public function readExtendedMetadata($meta, array &$config)
    {
        ...
        //throw new \MongoExtensions\Exception\UnexpectedValueException('Class ' . $meta->name . ' is not a valid entity or mapped super class.');
    }

...
namespace MongoExtensions\Loggable\Mapping\Driver;

use Doctrine\Common\Persistence\Mapping\ClassMetadata;
use MongoExtensions\Exception\InvalidMappingException;
use MongoExtensions\Mapping\Annotation\Loggable;
use MongoExtensions\Mapping\Annotation\Versioned;
use MongoExtensions\Mapping\Driver\AbstractAnnotationDriver;
...
class Annotation extends AbstractAnnotationDriver
{
    ...
    public function readExtendedMetadata($meta, array &$config)
    {
        ...
        // class annotations
        if ($annot = $this->reader->getClassAnnotation($class, Loggable::class)) {

...
namespace MongoExtensions\Loggable;

use Doctrine\Common\EventArgs;
use MongoExtensions\Exception\InvalidArgumentException;
use MongoExtensions\Mapping\MappedEventSubscriber;
use MongoExtensions\Loggable\Mapping\Event\LoggableAdapter;
use MongoExtensions\Tool\Wrapper\AbstractWrapper;
...
class LoggableListener extends MappedEventSubscriber
{
     ...
     * @param LoggableAdapter $ea
     *
     * @return \MongoExtensions\Loggable\Document\MappedSuperclass\AbstractLogEntry|null
     * @throws \Exception
     */
    protected function createLogEntry($action, $object, LoggableAdapter $ea)
    {
        ...
        if ($config = $this->getConfiguration($om, $meta->name)) {
            ...
            /** @var \MongoExtensions\Loggable\Document\LogEntry $logEntry */
